...
%%===========================
Используя материал осеннего семестра (код в~папке \code{asm\_seminars}), напишите программу на~языке \lang{C++}, которая будет моделировать работу и рисовать на~экране одну из~следующих логических схем:
\begin{enumissue}
